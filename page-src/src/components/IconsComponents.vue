  ...
  <div class="content">
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="box-body">
            <div class="custom-icon">
              ...
              <section id="customicon">
                ...
                <div class="row fontawesome-icon-list">
                  <div class="col-md-3 col-sm-4">
                    <img src="../assets/img/agent.png" width="30">
                    Agent
                  </div>
                  <div class="col-md-3 col-sm-4">
                    <img src="../assets/img/customer.png" width="30">
                    Customer
                  </div>
                  <div class="col-md-3 col-sm-4">
                    <img src="../assets/img/system.png" width="30">
                    System
                  </div>
                </div>
              </section>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-tag"></i> Fontawesome Icons</h3>
          </div>
          <div class="box-body">
            <div class="custom-icon">
              <section id="new">
